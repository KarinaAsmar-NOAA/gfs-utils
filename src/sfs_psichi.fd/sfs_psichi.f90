! This program reads isobaric winds on grid points from a grib2 file, 
! transforms them back to spectrum space using the NCEPLIBS-SP library,
! and then computes psi, chi, vorticity, and divergence. PSI and CHI
! are saved in output grib2 file.
!
! This program is based on the CFS cfs_genpsiandchi.fd utility authored
! by Saha, Chuang, and Moorthi.
!
      use grib_mod
